  ...
  return (
    <section className="flex flex-col justify-center px-6 pt-48 pb-32 bg-gradient-1">
      <div className="max-w-5xl mx-auto w-full">
        <p className="text-[#888] text-sm tracking-widest uppercase mb-6">Social Media &amp; Marketing</p>
        ...
        <p className="text-[#888] text-lg md:text-xl max-w-xl mb-12 leading-relaxed">
          ...
          I'm a marketer with over 2 years of experience in paid display ads, graphic design and content creation.
        </p>
